...
$zip = Join-Path $dist $(if ($SlaveOnly) { 'Remote-Monitor-Slave-v0.1.50-win11-net48.zip' } else { 'Remote-Monitor-v0.1.50-win7-win11-net48.zip' })
...
foreach ($executable in $targetExecutables) {
    $verification = Join-Path $dist 'verification-v0.1.50'
